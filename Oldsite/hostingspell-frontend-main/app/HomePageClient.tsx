...
const DomainSearchSection = lazy(() => import("./components/DomainSearchSection"));
...
const ShowcasePreview = lazy(() => import("./components/ShowcasePreview").then(mod => ({ default: mod.ShowcasePreview })));
