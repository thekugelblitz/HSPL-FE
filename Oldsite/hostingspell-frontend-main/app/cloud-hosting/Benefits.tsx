					...
					<div className="grid md:grid-cols-3 gap-12 items-center">
						<div className="md:col-span-2">
							...
							<div className="flex items-center gap-6 mt-2">
								<a
									href="https://manage.hostingspell.com/store/ssd-web-hosting"
									target="_blank"
						...
						<div className="relative justify-center hidden md:flex">
							<div className="aspect-square bg-transparent rounded-2xl p-0">
								<img
									src="/img/cloud-hosting-illustration-light.png"
									alt="Cloud Hosting Illustration Light"
									width={512}
									height={512}
									loading="lazy"
									decoding="async"
								...
								/>
								<img
									src="/img/cloud-hosting-illustration-dark.png"
									alt="Cloud Hosting Illustration Dark"
									width={512}
									height={512}
									loading="lazy"
									decoding="async"
