...
const cloudHostingFaqs = [
    ...
    { question: "What billing cycles do you offer?", answer: "We provide Annual billing for Cloud Hosting & Monthly and Annual based billing on Dedicated Hosting :)" },
...
export default function CloudHostignPageClient() {
    return (
        <>
