...
const LOCATIONS = [
	{ code: "IND", label: "India", countryCode: "IN", currency: "₹" },
	{ code: "SGP", label: "Singapore", countryCode: "SG", currency: "$" },
	{ code: "USA", label: "USA", countryCode: "US", currency: "$" },
	{ code: "UK", label: "UK", countryCode: "GB", currency: "£" },
	{ code: "NET", label: "Netherlands", countryCode: "NL", currency: "€" },
]

export function ServerLocationDropdown() {
				...
				<div className="rounded-xl p-4 bg-white text-black dark:bg-neutral-900 dark:text-white">
					<div className="flex items-center justify-between mb-3">
						...
						<div className="flex gap-2">
							<button
								aria-label="Set currency to Rupee"
								aria-pressed={currency === "₹"}
								className={`w-8 h-8 flex items-center justify-center rounded-full text-lg font-bold transition-colors ${currency === "₹"
									? "bg-blue-600 text-white"
									: "bg-gray-100 text-blue-600 dark:bg-neutral-800 dark:text-blue-200"
									}`}
								onClick={() => setCurrency("₹")}
							>
								₹
							...
							<button
								aria-label="Set currency to Dollar"
								aria-pressed={currency === "$"}
								className={`w-8 h-8 flex items-center justify-center rounded-full text-lg font-bold transition-colors ${currency === "$"
									? "bg-blue-600 text-white"
									: "bg-gray-100 text-blue-600 dark:bg-neutral-800 dark:text-blue-200"
